...
public class InquiryManagerClient {
        ...
        while (running) {
            try {
                ...
                if (response instanceof ResponseData) {
                    ...
                    if (((ResponseData) response).getResult()!=null) {
    ...
    public RequestData addRepresentative() {
        Scanner scanner = new Scanner(System.in);
    ...
    public RequestData deleteRepresentative() {
        Scanner scanner = new Scanner(System.in);
    ...
    public RequestData isRepresentativeActive() {
    ...
    public RequestData getRepresentativeInquiries() {

        Scanner scanner = new Scanner(System.in);
        System.out.print("Enter representative name to get inquiries: ");
        int id = Integer.parseInt(scanner.nextLine());
        return new RequestData(InquiryManagerActions.GET_REPRESENTATIVE_INQUIRIES, List.of(id));
    }

    public RequestData getRepresentativeNameByInquiryCode() {
